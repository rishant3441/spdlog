...
inline void pattern_formatter::need_localtime(bool need)
{
...
// Return padding.
inline details::padding_info pattern_formatter::handle_padspec_(std::string::const_iterator &it, std::string::const_iterator end)
{
